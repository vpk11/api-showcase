  ...
  render() {
    ...
    const versionsList = this.state.versions.map((version) => (
      <ShowVersionListItem
        ...
        key={version.id}
        handleVersionListClick={(versions) => {
        ...
        <Card>
          <Accordion.Toggle as={Card.Header} style={colStyle} eventKey="0">
            <Row>
              ...
              <IconButton
                aria-label="delete"
                onClick={this.handleChange("DELETE")}
              >
                {" "}
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <ListGroup>
                <Row>
                  <Col>{this.props.projectDescription}</Col>
                  <Col>
                    <Button
                      variant="outline-primary"
                      style={newVersionButtonStyle}
                      size="sm"
                      href="/versions/new"
                    >
                      New Version
              ...
              <ListGroup style={containerMarginStyle}>{versionsList}</ListGroup>
            </Card.Body>
          </Accordion.Collapse>
        </Card>
      </Accordion>
